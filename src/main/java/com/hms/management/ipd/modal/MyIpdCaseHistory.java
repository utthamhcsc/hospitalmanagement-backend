...
/*    */
/*    */ @Entity
/*    */ @Table(name = "MyIpdCaseHistory")
/*    */ public class MyIpdCaseHistory {
	/*    */ @Id
	...
	public boolean equals(Object o) {
		if (o == this)
			return true;
		if (!(o instanceof MyIpdCaseHistory))
			return false;
		MyIpdCaseHistory other = (MyIpdCaseHistory) o;
	...
	protected boolean canEqual(Object other) {
		return other instanceof MyIpdCaseHistory;
	}



	public String toString() {
		return "MyIpdCaseHistory(id=" + getId() + ", medicianCategory=" + getMedicianCategory() + ", medicine="
				+ getMedicine() + ", dosage=" + getDosage() + ", instruction=" + getInstruction() + ")";
	}

	public MyIpdCaseHistory(int id, String medicianCategory, String medicine, String dosage, String instruction) {
		/* 15 */ this.id = id;
		this.medicianCategory = medicianCategory;
		this.medicine = medicine;
		this.dosage = dosage;
 ...
 * MyIpdCaseHistory.class Java compiler version: 8 (52.0) JD-Core Version: 1.1.3
 */