...
/*    */ public class OrganisationsCharges {
	...
	public boolean equals(Object o) {
		if (o == this)
			return true;
		if (!(o instanceof OrganisationsCharges))
			return false;
		OrganisationsCharges other = (OrganisationsCharges) o;
	...
	protected boolean canEqual(Object other) {
		return other instanceof OrganisationsCharges;
	}


	public String toString() {
		return "OrganisationsCharges(id=" + getId() + ", organisationId=" + getOrganisationId() + ", organisationName="
				+ getOrganisationName() + ", charges=" + getCharges() + ")";
	}

	public OrganisationsCharges(int id, int organisationId, String organisationName, String charges) {
		/* 15 */ this.id = id;
		this.organisationId = organisationId;
		this.organisationName = organisationName;
		this.charges = charges;
 ...
 * OrganisationsCharges.class Java compiler version: 8 (52.0) JD-Core Version:
 * 1.1.3
 */